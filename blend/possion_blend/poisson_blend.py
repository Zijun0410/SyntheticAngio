"""
The code in this file is based on the following implementation by Willem Manuel:
...
def mask_indicies(mask):
    ...
    return tuple(zip(nonzero[0], nonzero[1]))
...
def process(source, target, mask):
    ...
    # N is the number of points in the mask
    N = len(indicies)
